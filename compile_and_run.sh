...
# ./infer -f weights/yolov7_det_dynamic_int8.engine -i res/dog.jpg -b 16 -c 10 -o cuda_res
# ./infer -f weights/yolox_det_dynamic_int8.engine -i res/dog.jpg -b 16 -c 10 -o cuda_res
